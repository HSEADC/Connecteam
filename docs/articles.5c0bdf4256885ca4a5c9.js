...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var feedbackCard = document.getElementById('I_article_feedback');
  if (feedbackCard) {
...
function Sticker(_ref) {
  ...
  sticker.innerHTML = "\n      <img src=\"".concat(imageSrc, "\" alt=\"Sticker\">\n      <div class=\"sticker-content\">").concat(content.length > maxLength ? content.substring(0, maxLength) + '...' : content, "</div>\n    ");
