...
const htmlWebpackPlugins = [
  ...
  createPages('./src/pages/errors/404.html', '404', ['header', 'O_footer', 'error_404']),
  createPages('./src/pages/errors/500.html', '500', ['header', 'O_footer', 'error_500']),
  createPages('./src/pages/errors/505.html', '505', ['header', 'O_footer', 'error_505']),
